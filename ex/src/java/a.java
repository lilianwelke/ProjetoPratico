package br.com.tecnicon.server.html;
...
import br.com.tecnicon.server.intercept.TecInterceptor;
 ...
 */
@Stateless
@Interceptors(TecInterceptor.class)
public class UploadArquivo {

    public String Enviar(VariavelSessao vs) throws ExcecaoTecnicon, IOException, NoSuchMethodException {
            ...
            try {
                ...
                while (itr.hasNext()) {
                    ...
                    try {
                        ...
                        if (!"true".equals(vs.getParameter("reduzImagem"))) {
                            int read = 0;
                            byte[] bytes = new byte[1024];
